#!/bin/bash
# This is a camilo-style server script for the Noumena web server.
...
GUID='45e0a951-ccd5-4ee5-a092-67ac9a1c80f8'

# Port number. Express uses this.
export PORT=59969
...
origin='git://github.com/CamiloMM/Noumena.git'
...
modules() {
    ...
    old="$PWD"
    cd "$(base)"
    target="deps/native/$(uname -s)-$(uname -m)-node-$(node -v)"
